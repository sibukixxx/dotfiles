...
- **AD/内部ネットワーク？** → `references/post-exploitation.md` の Active Directory セクション
- **権限昇格テスト？** → `references/post-exploitation.md` の Linux/Windows セクション
- **コードレビュー？** → `skills/security-audit/references/owasp-checklist.md` の OWASP Top 10 チェックリスト
